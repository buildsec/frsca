...
#CustomResourceDefinitionSpec: {
	...
	// +optional
	Validation?: null | #CustomResourceValidation @go(,*CustomResourceValidation)

	// Subresources describes the subresources for CustomResource
	// Optional, the global subresources for all versions.
	// Top-level and per-version subresources are mutually exclusive.
	// +optional
	Subresources?: null | #CustomResourceSubresources @go(,*CustomResourceSubresources)
	...
	Versions: [...#CustomResourceDefinitionVersion] @go(,[]CustomResourceDefinitionVersion)

	// AdditionalPrinterColumns are additional columns shown e.g. in kubectl next to the name. Defaults to a created-at column.
	// Optional, the global columns for all versions.
	// Top-level and per-version columns are mutually exclusive.
	// +optional
	AdditionalPrinterColumns: [...#CustomResourceColumnDefinition] @go(,[]CustomResourceColumnDefinition)

	// `conversion` defines conversion settings for the CRD.
	Conversion?: null | #CustomResourceConversion @go(,*CustomResourceConversion)
	...
	PreserveUnknownFields?: null | bool @go(,*bool)
}
...
#CustomResourceConversion: {
	...
	WebhookClientConfig?: null | #WebhookClientConfig @go(,*WebhookClientConfig)
	...
	// +optional
	ConversionReviewVersions: [...string] @go(,[]string)
}
...
#WebhookClientConfig: {
	...
	//
	// +optional
	Service?: null | #ServiceReference @go(,*ServiceReference)

	// `caBundle` is a PEM encoded CA bundle which will be used to validate the webhook's server certificate.
	// If unspecified, system trust roots on the apiserver are used.
	// +optional
	CABundle: bytes @go(,[]byte)
}
...
#CustomResourceDefinitionVersion: {
	...
	DeprecationWarning?: null | string @go(,*string)
	...
	// +optional
	Schema?: null | #CustomResourceValidation @go(,*CustomResourceValidation)
...
#CustomResourceDefinitionStatus: {
	...
	// +listType=map
	// +listMapKey=type
	Conditions: [...#CustomResourceDefinitionCondition] @go(,[]CustomResourceDefinitionCondition)
	...
	StoredVersions: [...string] @go(,[]string)
}
...
#CustomResourceDefinitionList: {
	...
	Items: [...#CustomResourceDefinition] @go(,[]CustomResourceDefinition)
}

// CustomResourceValidation is a list of validation methods for CustomResources.
#CustomResourceValidation: {
	// OpenAPIV3Schema is the OpenAPI v3 schema to be validated against.
	OpenAPIV3Schema?: null | #JSONSchemaProps @go(,*JSONSchemaProps)
}

// CustomResourceSubresources defines the status and scale subresources for CustomResources.
#CustomResourceSubresources: {
	// Status denotes the status subresource for CustomResources
	Status?: null | #CustomResourceSubresourceStatus @go(,*CustomResourceSubresourceStatus)

	// Scale denotes the scale subresource for CustomResources
	Scale?: null | #CustomResourceSubresourceScale @go(,*CustomResourceSubresourceScale)
}
...
#CustomResourceSubresourceScale: {
	...
	// +optional
	LabelSelectorPath?: null | string @go(,*string)
}
