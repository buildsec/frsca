...
kubectl apply -f "${GIT_ROOT}/platform/vendor/tetragon/tracingpolicy/sys_write_follow_fd_prefix.yaml"
kubectl apply -f "${GIT_ROOT}/platform/vendor/tetragon/tracingpolicy/tcp-connect.yaml"