...
./vendor-helm-chart.sh "$@" -d ./spire/crd         -c spire-crds     -v 0.3.0   -r https://spiffe.github.io/helm-charts-hardened
./vendor-helm-chart.sh "$@" -d ./spire/server      -c spire          -v 0.19.2  -r https://spiffe.github.io/helm-charts-hardened
...
./vendor-helm-chart.sh "$@" -d ./gitea/chart       -c gitea          -v 12.4.0  -r https://dl.gitea.io/charts/
